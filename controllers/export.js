...
exports.exportPDF = async (req, res, next) => {
  try {
    ...
    res.setHeader('Content-Disposition', `attachment; filename=RAB_${project.name}.pdf`);
...
exports.exportExcel = async (req, res, next) => {
  try {
    ...
    res.setHeader('Content-Disposition', `attachment; filename=RAB_${project.name}.xlsx`);
